...
RECORD_TYPE_CORRECTIONS = {
    ...
    # 教練2026-08-18指出：只要行事曆當天實際場次是「工作坊」而非M1/M2，全部要更正成工作坊，逐一查證後只有這兩天真的錯
    ("陳佩君", "2026-06-08", "董事培訓 - Taiwan"): "簡報+PT工作坊",
    ("楊在珍", "2026-06-08", "董事培訓 - Taiwan"): "簡報+PT工作坊",
    ("林佳伶 Lavi", "2026-07-06", "董事培訓 - Taiwan"): "引薦+1對1工作坊",
}
